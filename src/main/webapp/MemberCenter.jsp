...
<html lang="en">
<head>
    <link href="MemberCenter.css" rel="stylesheet" type="text/css">
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="personal"><h3>個人訊息</h3>
        <div class="human" id="MemberCenter-img"><!--顯示會員的圖像id-->
            <img src="圓形圖像.png" width="150" height="150" >
    </div> 
    ...
    <div class=container>
       ...
       <a href="Order-inquary.html" target="blank">訂單查詢</a>
       <p><a href="Order-love.html" target="blank"><p>追蹤清單</a></p>
       <p><a href="CustomerService.html" target="blank"><p>聯絡客服</a></p>
       </div>

       <div class="memberdata"><h3>會員資料</h3>
       <a href="Member-data.html" target="blank">個人資料填寫</a>
       <p><a href="Member-edit.html" target="blank">修改</a></p>
       <p></p><a href="Member-inquary.html" target="blank">查看</a></p>
       </div>
    </div>
