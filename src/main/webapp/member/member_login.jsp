            ...
            <div class="main-content">
                <div class="container">
                    ...
                    <section class="content">
                        <div class="content-title"><span>會員登入</span></div>
                        <div class="form-wrap type3 line">
                            <div class="form-box">
                                <form id="" name="frmlogin" method="post" action="#">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="control-box">
                                                    <input class="form-control validate[required,custom[email]]"
                                                        type="text" name="account" id="memberlogin_id" value=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="control-box">
                                                    <input class="form-control validate[required]" type="password"
                                                        name="password" id="memberilogin_password" value=""
                                                        placeholder="請輸入密碼" tabindex="2" autocomplete="off">
                                                </div>
                                            </div>
                                            <a href="javascript:void(0)" class="btn pure">忘記密碼？</a>
                                            <a href="member_register.html" class="btn pure">會員註冊</a>
                                        </div>
                                        <div class="col col2">
                                            <button type="submit" class="btn normal2 send">LOGIN 登入</button>
                                        </div>
                                    </div>
                                </form>
