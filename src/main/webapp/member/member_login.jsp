	...
	<div class="flex-container">
		...
		<section class="top_navi">
         ...
         <div class="centercard">
			<div class="logintitle"><div class="logintitletext">尊爵貴賓卡</div></div>
			 <div class="row">
				 <div class="col-2  hahaha"><img src="../images/common/login_晶片圖.png"  class="loginimgone"></div>
				  <!-- 登入區塊表單  -->
				 <div class="col-7">
					<form id="" name="frmlogin" method="post" action="login.do" onSubmit="return check()">
						...
						<table class="tableareatotal">
						  <tr>
							 <td><!-- 輸入帳號  -->
								   ...
								   <p><Font color='red' size="-3">${ErrorMsgKey.AccountEmptyError}</Font></p>
							 </td> 
						  </tr>
							<!-- 輸入密碼  -->   <!-- 認證碼輸入-->
						  <tr>
				             <td>
						       <input class="validate[required]"
								...
								placeholder="請輸入密碼"autocomplete="off"></br>
								 ...
								 <input type="checkbox" name="rememberMe"
								   ...
								   value="true">
								   <!-- 輸入密碼錯誤顯示區塊  --> 
						        <p><Font color='red' size="-3">${ErrorMsgKey.PasswordEmptyError}</Font></p>
								<p><Font color='red' size="-1">${msg}${ErrorMsgKey.LoginError}&nbsp;</Font></p>
				...
				<button type="button"  class="btn btn-outline-danger" id="forgetbtn">忘記密碼<i class='bx bx-question-mark'></i></button>
